...
<script>
	let plugins = ["link" ,"image","accordion"];
	let edit_toolbar = "link image forecolor backcolor accordion styles | blocks fontfamily fontsize | bold italic underline strikethrough | align |"
